...
namespace ConsoleBingSearch
{
    ...
    class Program
    {
        ...
        const string accessKey = "8d37f2ff4a6041cea82e7fa551dc555f";
        ...
        static void Main(string[] arg)
        {
            ...
            Console.WriteLine("Searching news for: " + _searchTerm);

            SearchResult result = BingNewsSearch(_searchTerm);
